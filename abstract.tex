...
For evaluation a subset of \gls{bpmn} elements have been implemented in a discrete event simulation framework, in which existing policies for role resolution in \glspl{wfms}, such as \gls{sq}, \gls{llqp}, K-Batch and 1-Batch-1 are tested.
