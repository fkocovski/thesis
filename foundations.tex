...
\fig[\textwidth]{normal_process}{\glsentryshort{bpmn} process showing a usual process starting with a start event (green) on the leftmost side, followed by different user tasks (purple) and gateways (orange) and eventually two different end events (red).}{fig:normal_process}
