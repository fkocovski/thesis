...
\fig[\textwidth]{opt_kpis_comp_gain}{Speedup comparison between \glsentryshortpl{kpi} for \glsentryshort{msa} and \glsentryshort{st} for 5-Batch, 5-Batch-1 and 1-Batch-1. Values bigger than $1.00$ indicate speedup. Higher is better.}{fig:opt_kpis_comp_gain}
