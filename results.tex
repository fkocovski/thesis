...
\section{\glsentrylong{milp} Results}
...
\fig[\textwidth]{opt_kpis_comp}{\glsentryshortpl{kpi}  comparison for different optimization policies using \glsentryshort{msa}}{fig:opt_kpis_comp}  
...
\fig[\textwidth]{opt_st_kpis_comp}{\glsentryshortpl{kpi}  comparison for different optimization policies using \glsentryshort{st}}{fig:opt_st_kpis_comp}
