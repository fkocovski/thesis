...
This chapter outlines the results obtained by the \gls{milp} approach in \secref{sec:opt_comparison} respectively the \gls{rl} approach in \secref{sec:rl_results} following the guidelines defined in \chpref{ch:empirical_analysis}.
...
\section{\glsentrylong{milp} Results and Comparison with Existing Literature}
